...
var navSlides = function navSlides() {
  var burger = document.querySelector(".burger");
  var nav = document.querySelector(".nav-link");
  var navLink = document.querySelectorAll(".nav-link li");
...
document.addEventListener("mousemove", function (e) {
  ...
  updateDimensions(); //if(mouseIsDown) {
...
function windowResize() {
  updateDimensions();
  var skyHeight = document.getElementById("horizon").clientHeight; // update to new sky height
...
var Expand = function () {
  ...
  var open = function open() {
    ...
    if (!expanded) {
      tile.addClass('strips__strip--expanded'); // add delay to inner text
  ...
  var close = function close() {
    if (expanded) {
      tile.removeClass('strips__strip--expanded'); // remove delay from inner text
